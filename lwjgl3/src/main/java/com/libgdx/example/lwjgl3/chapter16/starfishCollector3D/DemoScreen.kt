...
class DemoScreen : BaseScreen() {
    ...
    override fun initialize() {
        ...
        screen.loadTexture("chapter16/starfishCollector3D/starfish-collector.png")

        val markerO = Box(0f, 0f, 0f, mainStage3D)
        markerO.setColor(Color.BROWN)
        markerO.loadTexture("chapter16/starfishCollector3D/crate.jpg")

        val markerX = Box(5f, 0f, 0f, mainStage3D)
        markerX.setColor(Color.RED)
        markerX.loadTexture("chapter16/starfishCollector3D/crate.jpg")

        val markerY = Box(0f, 5f, 0f, mainStage3D)
        markerY.setColor(Color.GREEN)
        markerY.loadTexture("chapter16/starfishCollector3D/crate.jpg")

        val markerZ = Box(0f, 0f, 5f, mainStage3D)
        markerZ.setColor(Color.BLUE)
        markerZ.loadTexture("chapter16/starfishCollector3D/crate.jpg")

        player = Sphere(0f, 1f, 8f, mainStage3D)
        player.loadTexture("chapter16/starfishCollector3D/sphere-pos-neg.png")
