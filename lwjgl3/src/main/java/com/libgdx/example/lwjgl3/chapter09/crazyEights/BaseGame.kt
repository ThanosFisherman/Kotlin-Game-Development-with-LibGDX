...
abstract class BaseGame : Game() {
    ...
    companion object {
        ...
        fun writeHighScore(highScore: Int) {
            val file = Gdx.files.local("chapter09/crazyEights/highscore.txt")
        ...
        private fun readFromFile(): Int {
            val file = Gdx.files.internal("chapter09/crazyEights/highscore.txt")
    ...
    override fun create() {
        ...
        val fontGenerator = FreeTypeFontGenerator(Gdx.files.internal("chapter09/crazyEights/OpenSans.ttf"))
        ...
        /*labelStyle!!.font = BitmapFont(Gdx.files.internal("chapter09/crazyEights/cooper.fnt"))*/

        textButtonStyle = TextButtonStyle()
        val buttonTex = Texture(Gdx.files.internal("chapter09/crazyEights/button.png"))
