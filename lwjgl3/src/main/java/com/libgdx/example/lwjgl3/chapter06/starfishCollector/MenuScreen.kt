...
class MenuScreen: BaseScreen() {
    ...
    override fun initialize() {
        ...
        ocean.loadTexture("chapter06/starfishCollector/water.jpg")
        ocean.setSize(800f, 600f)

        val title = BaseActor(0f, 0f, mainStage)
        title.loadTexture("chapter06/starfishCollector/starfish-collector.png")
        /*title.centerAtPosition(400f, 300f)
        title.moveBy(0f, 100f)*/

        /*var start = BaseActor(0f, 0f, mainStage)
        start.loadTexture("chapter06/starfishCollector/message-start.png")
        ...
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("chapter06/starfishCollector/fantasy-orchestra.wav"))
