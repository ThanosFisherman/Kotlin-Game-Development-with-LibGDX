...
class Turtle(x: Float, y: Float, s: Stage) : BaseActor(x, y, s) {
    ...
    init {
        ...
        fileNames.add("chapter05/starfishCollector/turtle-1.png")
        fileNames.add("chapter05/starfishCollector/turtle-2.png")
        fileNames.add("chapter05/starfishCollector/turtle-3.png")
        fileNames.add("chapter05/starfishCollector/turtle-4.png")
        fileNames.add("chapter05/starfishCollector/turtle-5.png")
        fileNames.add("chapter05/starfishCollector/turtle-6.png")
