...
class StoryScreen2: BaseScreen() {
    ...
    override fun initialize() {
        ...
        background.loadTexture("chapter06/starfishCollector/oceanside.png")
        background.setSize(800f, 600f)
        background.setOpacity(0f)
        BaseActor.setWorldBounds(background)

        val turtle = BaseActor(0f, 0f, mainStage)
        turtle.loadTexture("chapter06/starfishCollector/turtle-big.png")
        ...
        continueKey.loadTexture("chapter06/starfishCollector/key-C.png")
        ...
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("chapter06/starfishCollector/box-melody-1.mp3"))
        ...
        scene.addSegment(SceneSegment(dialogBox, SceneActions.setText("I collected all the Starfish!")))
