...
abstract class BaseGame : Game() {
    ...
    override fun create() {
        ...
        val fontGenerator = FreeTypeFontGenerator(Gdx.files.internal("chapter06/rhythmTapper/OpenSans.ttf"))
        ...
        /*labelStyle!!.font = BitmapFont(Gdx.files.internal("chapter06/rhythmTapper/cooper.fnt"))*/

        textButtonStyle = TextButtonStyle()
        val buttonTex = Texture(Gdx.files.internal("chapter06/rhythmTapper/button.png"))
