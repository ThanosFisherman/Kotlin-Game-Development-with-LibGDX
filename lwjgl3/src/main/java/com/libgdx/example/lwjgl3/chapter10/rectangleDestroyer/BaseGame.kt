...
abstract class BaseGame : Game() {
    ...
    override fun create() {
        ...
        val fontGenerator = FreeTypeFontGenerator(Gdx.files.internal("chapter10/rectangleDestroyer/OpenSans.ttf"))
        ...
        /*labelStyle!!.font = BitmapFont(Gdx.files.internal("chapter10/rectangleDestroyer/cooper.fnt"))*/

        textButtonStyle = TextButtonStyle()
        val buttonTex = Texture(Gdx.files.internal("chapter10/rectangleDestroyer/button.png"))
