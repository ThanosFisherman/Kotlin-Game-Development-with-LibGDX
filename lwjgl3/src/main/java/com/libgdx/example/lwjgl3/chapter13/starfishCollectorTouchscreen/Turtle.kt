...
class Turtle(x: Float, y: Float, s: Stage) : BaseActor(x, y, s) {
    ...
    init {
        ...
        fileNames.add("chapter13/starfishCollectorTouchscreen/turtle-1.png")
        fileNames.add("chapter13/starfishCollectorTouchscreen/turtle-2.png")
        fileNames.add("chapter13/starfishCollectorTouchscreen/turtle-3.png")
        fileNames.add("chapter13/starfishCollectorTouchscreen/turtle-4.png")
        fileNames.add("chapter13/starfishCollectorTouchscreen/turtle-5.png")
        fileNames.add("chapter13/starfishCollectorTouchscreen/turtle-6.png")
