...
abstract class BaseGame : Game() {
    ...
    override fun create() {
        ...
        val fontGenerator = FreeTypeFontGenerator(Gdx.files.internal("chapter13/starfishCollectorTouchscreen/OpenSans.ttf"))
        ...
        /*labelStyle!!.font = BitmapFont(Gdx.files.internal("chapter13/starfishCollectorTouchscreen/cooper.fnt"))*/

        textButtonStyle = TextButtonStyle()
        val buttonTex = Texture(Gdx.files.internal("chapter13/starfishCollectorTouchscreen/button.png"))
