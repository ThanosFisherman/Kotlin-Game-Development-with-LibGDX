...
abstract class BaseGame : Game() {
    ...
    companion object {
        ...
        fun writeHighScore(highScore: Int) {
            val file = Gdx.files.local("chapter09/cardPickup52/highscore.txt")
        ...
        private fun readFromFile(): Int {
            val file = Gdx.files.internal("chapter09/cardPickup52/highscore.txt")
    ...
    override fun create() {
        ...
        val fontGenerator = FreeTypeFontGenerator(Gdx.files.internal("chapter09/cardPickup52/OpenSans.ttf"))
        ...
        /*labelStyle!!.font = BitmapFont(Gdx.files.internal("chapter09/cardPickup52/cooper.fnt"))*/

        textButtonStyle = TextButtonStyle()
        val buttonTex = Texture(Gdx.files.internal("chapter09/cardPickup52/button.png"))
