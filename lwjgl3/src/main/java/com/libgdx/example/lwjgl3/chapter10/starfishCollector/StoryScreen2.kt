...
class StoryScreen2: BaseScreen() {
    ...
    override fun initialize() {
        ...
        background.loadTexture("chapter10/starfishCollector/oceanside.png")
        background.setSize(800f, 600f)
        background.setOpacity(0f)
        BaseActor.setWorldBounds(background)

        val turtle = BaseActor(0f, 0f, mainStage)
        turtle.loadTexture("chapter10/starfishCollector/turtle-big.png")
        ...
        continueKey.loadTexture("chapter10/starfishCollector/key-C.png")
        ...
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("chapter10/starfishCollector/box-melody-1.mp3"))
